...
if (isset($_POST['txtAnoRepo']) && !empty($_POST['txtAnoRepo'])) {
	...
	$anoRepoClase = $anoRepo-18;
	$_SESSION['anoRepo'] = $anoRepo;
	$_SESSION['anoRepoClase'] = $anoRepoClase;
...
echo '
			<tr>
	 			...
	 			<th>0</th>
					...
					<div class="ocultar">
					<div class="form-group col-md-12">
					<a href="ano.php"><button type="button"class="btn btn-outline-info"/>Regresar</button></a>
					<a href="impreRepoAno.php"><button type="button" class="btn btn-success animated pulse delay-1s infinite"/><i class="fas fa-print"></i> Imprimir</button></a>
					</div>
					</div>							
</div>

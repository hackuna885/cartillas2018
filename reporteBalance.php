...
if (isset($_POST['txtMatUno']) && !empty($_POST['txtMatUno']) &&
	isset($_POST['txtMatDos']) && !empty($_POST['txtMatDos']) &&
	isset($_POST['txtAnoRepoB']) && !empty($_POST['txtMatUno'])) {

	$matUno = $_POST['txtMatUno'];
	$matDos = $_POST['txtMatDos'];
	$anoRepoB = $_POST['txtAnoRepoB'];

	$_SESSION['matUno'] = $matUno;
	$_SESSION['matDos'] = $matDos;

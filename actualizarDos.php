...
if (isset($_GET["matriculaMod"]) && !empty($_GET["matriculaMod"])) {
	$folioX = $_GET["matriculaMod"];
	$_SESSION['folio'] = $_GET["matriculaMod"];
	...
	<div class="container">
		<div class="starter-template">
			...
			<form action="actualizarBase.php" method="post">
				...
				<input type="text" class="form-control" name="txtNacio" placeholder="Lugar de nacimiento" maxlength="39" pattern="{39}" autocomplete="off" value="'.$txtnacioCart.'"/>
				</div>
